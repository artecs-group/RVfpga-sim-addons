...
- Install the environment and test the RVfpga tools. Follow the instructions in the document [Practice_Familiarization_fpga](). Each section includes a link to a video illustrating its content. It is not necessary to complete the tasks proposed in the document.
