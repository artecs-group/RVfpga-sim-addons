...
In this lab we continue the analysis of the VeeR EH1 core, using the performance counters and executing the CoreMark benchmark. The exercises proposed should be performed both in RVfpga-ViDBo and on the FPGA board.

Follow the next steps:

1. Complete the following tasks:
	- For the RVfpga-Nexys FPGA board: Complete the following document [RVfpgaNexys_InitialTests](https://drive.google.com/file/d/1OtZvekekP1e0v28yUr1u0TI2xWcc8VFF/view?usp=sharing)
	- For the RVfpga-ViDBo simulator: Perform the guided example for RVfpga-ViDBo, provided in section *Introduction - Simulation of the RVfpga SoC in RVfpga-ViDBo* at [SimulationInRVfpgaViDBo](https://github.com/artecs-group/RVfpga-sim-addons/blob/main/Computer_Organization/Lab4/README.md#introduction---simulation-of-the-rvfpga-soc-in-rvfpga-vidbo). Note however that this example is hosted on a separate webpage. Once you finish, make sure to return here and continue with item 3.
...
## Exercise 2
In the VeeR EH1 processor, the following code is to be executed. Note that this is the same code used in [Exercise 5 of Lab 2 in RVfpgaPipeline](https://github.com/artecs-group/RVfpga-sim-addons/blob/main/Computer_Organization_25-26/Lab2_25-26/README.md#exercise-5-in-rvfpga-pipeline):
