...
2. Then, you can perform the guided example for RVfpga-ViDBo (if you are working with the FPGA board, you can skip this step), provided in section *Introduction - Simulation of the RVfpga SoC in RVfpga-ViDBo* at [here](https://github.com/artecs-group/RVfpga-sim-addons/blob/main/Computer_Organization/Lab4/README.md#introduction---simulation-of-the-rvfpga-soc). Note however that this example is hosted on a separate webpage. Once you finish, make sure to return here and continue with item 3.
