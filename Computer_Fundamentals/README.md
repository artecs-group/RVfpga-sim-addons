...
3. Starting with Ripes: Follow the instructions provided at this link: [Introduction to Ripes](https://github.com/mortbopet/Ripes/blob/master/docs/introduction.md). Specifically, read the following sections:  
...
4. Then follow the next steps to use Ripes natively in your device:
    - To-Do.
