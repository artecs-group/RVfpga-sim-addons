...
- 4 lines (field "2^N^ Lines = 2")
- 4 words per line (field "2^N^ Words/Lines = 2")
- 1 way (field "2^N^ Ways = 0")
...
- Two-way set associative:
  ...
  - Increase the number of ways to 2: 2^N^ Ways = 1
  - Reduce the number of lines to 2, to keep the total data cache size the same: 2^N^ Lines = 1
