...
2. Then, resolve the two exercises provided [below](https://github.com/artecs-group/RVfpga-sim-addons/tree/main/Computer_Organization/Lab3#exercise-1) using Ripes. These are the exercises you will include in the report, so make sure to write everything down as you work through them.
...
This is the result obtained after executing this program, with the values shown in hexadecimal (note for example that the first element of A is *0x103* in hexadecimal, which equals *259* in decimal):
