...
2. Then, view this video [InputOutputVideo](https://www.youtube.com/watch?v=8fK-CoEbo0Y) (you can download the slides [here](https://drive.google.com/file/d/1Fv4-I8DwISdqqDpol4i_BMZNzK4QmpOe/view?usp=sharing)), which describes the RVfpga I/O System in detail. The video is in Spanish, but English subtitles are available. Alternatively, you can watch an AI-translated-to-English version of the video: [InputOutputEnglishVideo](https://www.youtube.com/watch?v=oIRFxQEBNAc).
