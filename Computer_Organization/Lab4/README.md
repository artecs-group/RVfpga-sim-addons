...
2. Then, view this [video](https://www.youtube.com/watch?v=8fK-CoEbo0Y) (you can download the slides [here](https://drive.google.com/file/d/1Fv4-I8DwISdqqDpol4i_BMZNzK4QmpOe/view?usp=sharing)), which describes the RVfpga I/O System in detail. The video is in Spanish, but you can enable the subtitles and configure YouTube to automatically translate them into the language that you prefer.
