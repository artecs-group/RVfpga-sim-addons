...
4. Finally, you can resolve the exercises included [below](https://github.com/artecs-group/RVfpga-sim-addons/tree/main/Computer_Organization/Lab2#exercise-0), first theoretically and then on the simulators. If you want to continue practicing, you can find more complex exercises in RVfpga labs 11 to 18 than those included in this lab.
