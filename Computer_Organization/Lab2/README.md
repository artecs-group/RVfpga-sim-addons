...
2. Then, you should look at the detailed introduction to the VeeR EH1 microarchitecture that we provide in this presentation: [VeeR-EH1_Microarchitecture](https://drive.google.com/file/d/1rSlwCzcHD4F_S4YFLCFn3L0VNXH_sv7L/view?usp=drive_link). You can also visualize this [video](https://youtu.be/Otsp5hK5aFg?si=-aPWj2nBOaamBb8P), which describes the VeeR EH1 microarchitecture in detail (the video is in Spanish, but you can activate subtitles in English in YouTube).
