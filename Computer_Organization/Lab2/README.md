...
**SOLUTION:**
We next exceptionally show partial partial solutions for items c and d as an example. In case you want to obtain the remaining solutions, please contact ```dani02@ucm.es```.
