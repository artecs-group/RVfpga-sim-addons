...
2. Then, view this video: [VeeReh1Video](https://youtu.be/xVnB6OM00cE?si=0HW333O-oPOXUDZG) (you can download the slides [here](https://drive.google.com/file/d/1rSlwCzcHD4F_S4YFLCFn3L0VNXH_sv7L/view?usp=drive_link)), which describes the VeeR EH1 microarchitecture in detail. The video is in Spanish, but English subtitles are available. Alternatively, you can watch an AI-translated-to-English version of the video: [VeeReh1EnglishVideo](https://www.youtube.com/watch?v=Ow_0l47xqV4).
