...
7. Follow the steps described above after the launch of the simulator: from step 3 both in Ubuntu, from step 3 in Windows (1st option), from step 6 in Windows (2nd option).
